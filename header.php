...
<head>
  ...
  <link rel="stylesheet"
      href="https://unpkg.com/owl.carousel@2.2.0/dist/assets/owl.carousel.min.css">
  <link rel="stylesheet"
      href="https://unpkg.com/owl.carousel@2.2.0/dist/assets/owl.theme.default.min.css">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">
            <img alt="nauka tańca wrocław"
                src="<?php bloginfo('template_url'); ?>/assets/img/sys/logo.png">
          </a>
        </div>
        <?php
        wp_nav_menu(array(
